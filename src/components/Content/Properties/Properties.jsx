...
const Properties = ({propertyStyle}) => {
    return (
        <div className={style.properties}>
            ...
            <div className={style.first_property} ><strong>Гарантия от 50 лет</strong><br />на материалы и 5<br />лет на монтаж</div>
            <div className={style.second_property}><strong>Замер, монтажный проект</strong> и<br />еще 4 услуги<br />бесплатно</div>
